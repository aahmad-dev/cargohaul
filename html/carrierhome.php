                            ...
                            <div class="col">
                                <div class="card mt-3">
                                    <div class="card-title ml-5 my-2 mr-5">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="document.location='addTruck.php'">Add New Truck</button>
                                    </div>
                                    <!--Display loads-->
                                    <div class="card-body" id="matchTable">
                                        ...
                                        <div>
                                            <?php
                                                $query = "select sh.shipperName, tr.shipFromLoc, tr.shipToLoc, tr.pickUpDate, tr.dropoffDate, tr.cost, tr.LoadSizePall from transactions as tr inner join shipper as sh on sh.shipperID = tr.shipperID order by tr.pickUpDate;";
